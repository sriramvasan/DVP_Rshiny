...
json_data <- fromJSON("Datasets/Refugee_per_state.json")
json_data_state <- fromJSON("Datasets/table-data.json")
heatmap <- read.csv("Datasets/API_SM.POP.REFG.OR_DS2_en_csv_v2_4696212.csv")
refugee_data <- read.csv("Datasets/clean_data_11_except_refused.csv")
unemployment_data <- read.csv("Datasets/unemployment_rate.csv")
